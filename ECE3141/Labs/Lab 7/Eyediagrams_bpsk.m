...
FilterSpan = 28;                                   % Filter FilterSpan % Changed from 14 to 28
rolloff_transmitter =0.5;                         % Rolloff factor
rolloff_receiver  = 0.10;                           % rolloff_receiver = rolloff_transmitter to implement a matched filter
