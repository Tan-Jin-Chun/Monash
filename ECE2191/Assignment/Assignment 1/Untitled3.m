...
% Printing out the value
fprintf("The probability of the subject not having P-wave is %f\n", 1-Prob_Pwave);
...
% Quiz Value
Bin_Values = [-inf,0.0632-0.0421/2:0.0421:0.3580+0.0421/2,inf];
...
% Printing out the values
fprintf("The probability that the P-wave absent given that the subject is diagnosed with AF is %f\n", 1-P_wave_AF);
...
% Printing out the values
fprintf("The mean and sd of SDRR for the patients diagnosed with AF is %f and %f\n", mean_AF, sqrt(var_AF));
